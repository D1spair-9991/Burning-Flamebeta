...
label = ui.new_label("AA", "Anti-aimbot angles", "                   \aAFAFC3FFBurning Flame [beta]")
label = ui.new_label("AA", "Anti-aimbot angles", "You only need to possess the Burning Flame.")
label = ui.new_label("AA", "Anti-aimbot angles", "then you can control the world. ")
label = ui.new_label("AA", "Anti-aimbot angles", " ")
label = ui.new_label("AA", "Anti-aimbot angles", "Last update: \aA8BDFFFF11.10.24")
label = ui.new_label("AA", "Anti-aimbot angles", "User name: " .. nickname)
label = ui.new_label("AA", "Anti-aimbot angles", " ")
label = ui.new_label("AA", "Anti-aimbot angles", " ")
label = ui.new_label("AA", "Anti-aimbot angles", "[Perform secondary encoding based on the Bloodstone script]")
label = ui.new_label("AA", "Anti-aimbot angles", " ")
label = ui.new_label("AA", "Anti-aimbot angles", " ")
local refs = {
ragebot = {
...
local lua_tabs = ui.new_combobox("AA", "Anti-aimbot angles", "\aFF9A9AFF Section", {"Anti-aim", "Visual", "Misc","Config"})
...
local anti_aim = {}
   anti_aim[0] = {
       ...
       aa_ditionals = ui.new_multiselect("AA", "Anti-aimbot angles","\aFFFFFFFF Anti-Aim additionals",{"Freestand","Edge Yaw","Manual"}),
       ...
       player_state = ui.new_combobox("AA", "Anti-aimbot angles", "\aDB90E2FFCustom states mode", var.player_pos),
   }
...
anti_aim[i] = {
   ...
   yaw_xway = ui.new_combobox("AA","Anti-aimbot angles","Yaw X-Way\n" .. var.player_pos[i],{"None","3 Way (offset)","4 Way (offset)","5 Way (offset)","Custom 3 Way","Custom 4 Way","Custom 5 Way", "Delayed Tick"}),
   yaw_xway_delay = ui.new_slider("AA", "Anti-aimbot angles", "Delayed Tick\n " .. var.player_pos[i] , 1, 64, 1),
   yaw_xway_desync = ui.new_combobox("AA", "Anti-aimbot angles", "Body mode\n" .. var.player_pos[i] ,{"None","Default","Invert","Positive","Negative","AI","private" }),
...
anti_aim[20] = {
   ...
   anti_knifebot_pistal = ui.new_checkbox("AA", "Anti-aimbot angles",  "Anti-Knifebot Use Pistol"),
   anti_knifebot_pistal_slider = ui.new_slider("AA", "Anti-aimbot angles","Enemy Health > X", 0, 100,75, true, nil, 1, { }),
            ...
            if contains(anti_aim[20].dt_teleport_opts,"Damage") then
                ...
                if need_dmg == 101 then
                    ...
                    if ui.get(anti_aim[20].dt_teleport_damage_opts) == 'local' then
                        ...
                        prd_dmg = 'AT'
                        tp_text = 'T: '..prd_dmg
                        renderer.indicator(200,200,200,255, ""..tp_text)
                    end
                ...
                if contains(anti_aim[20].dt_teleport_opts,"Once") then
                    raw_value = (0 > 0 or 0 > 0)
                else
                    raw_value = (0 > 0 or 0 > 0 or 0 > 0)
                    tp_text = 'T: '..raw_value
                    renderer.indicator(200,200,200,255, ""..tp_text)
                end
            else
  ...
  local function run_command(context)
      ...
      if closestplayer ~= nil then
         ...
         -- print('o_scan_fineness:'..o_scan_fineness)
          local l_add = o_scan_fineness
          local r_add = o_scan_fineness
...
local Information_Bar = ui.new_checkbox("AA", "Anti-aimbot angles", "Information Bar")
...
local Debug_panel_selector = ui.new_multiselect("AA", "Anti-aimbot angles", "Debug Selection",{"Logo","Build","Anti-aim state","EXP","LC"})
...
local micro_move = function(cmd)
   ...
   local DEFAULT = ui.new_button("AA","Anti-aimbot angles", "\aFFFFFFFFDefault Config", function()
       import_cfg_func("")
   end)
...
local function handle_menu()
   ...
   for i = 1, 19 do
      -- ui.set_visible(default_custom,rage and show_menu)
       ...
       ui.set_visible(anti_aim[i].yaw_xway_desync,rage and show_menu and var.active_i == i and ui.get(anti_aim[i].yaw) ~= "Off" and  (xway_type == "Delayed Tick" ) )
       ui.set_visible(anti_aim[i].yaw_xway_delay,rage and show_menu and var.active_i == i and ui.get(anti_aim[i].yaw) ~= "Off" and  (xway_type == "Delayed Tick" ) )
   ...
   local show_misc = ui.get(lua_tabs) == 'Misc'
       ...
       ui.set_visible(Information_Bar,show_misc and ui.get(misc_expoloit) == "Main Misc")
   ...
   local show_config = ui.get(lua_tabs) == 'Config'
...
local function run_aa(c, plocal)
   ...
   local EK = entity.get_classname(entity.get_player_weapon(plocal)) == "CKnife" 
...
var.p_state = 1
   ...
   if  ui.get(anti_aim[9].enable) and man_en  and  not p_key then
      ...
      -- c.force_defensive = 1
       var.p_state = 11
       elseif breaking_lc and ui.get(anti_aim[8].enable) and not EK then
           -- ["Breaking LC",] = 8,
           var.p_state = 8
       elseif   ui.get(anti_aim[16].enable) and (#entity.get_players(true) == 0) and not EK then
       -- ["Dormant"] = 16,
       var.p_state = 16
       elseif  ui.get(anti_aim[13].enable) and threat and height_to_threat > 25 and not EK then 
           -- ["Height advantage"] = 13,
           var.p_state = 13
       elseif  ui.get(anti_aim[14].enable) and threat and height_to_threat < -25 and not EK then 
           -- ["Height disadvantage"] = 14,
           var.p_state = 14
...
if ui.get(anti_aim[20].anti_knifebot) then
    local enemies = entity.get_players(true)
    for i,v in ipairs(enemies) do
        if get_wpn_class(v) == "CKnife"then
...
c.force_defensive = true
   ...
   if ui.get(anti_aim[var.p_state].yaw_xway)  == "Delayed Tick" then
              ...
              local sided = flick_handler(
               ...
               elseif ui.get(anti_aim[var.p_state].yaw_xway_desync) == "attack" then
                   ui.set(refs.antiaim.body_yaw[2], clamp(-180,180,val_yaw*2))
               elseif ui.get(anti_aim[var.p_state].yaw_xway_desync) == "defensive" then
                   ui.set(refs.antiaim.body_yaw[2], clamp(-180,180,val_yaw/2))
               elseif ui.get(anti_aim[var.p_state].yaw_xway_desync) == "AI" then
                   if val_yaw >= 0 then
                   ui.set(refs.antiaim.body_yaw[2], -58)
                   else
                   ui.set(refs.antiaim.body_yaw[2], 58)
                   end
               elseif ui.get(anti_aim[var.p_state].yaw_xway_desync) == "private" then
                   if val_yaw <= 0 then
                       ui.set(refs.antiaim.body_yaw[2], -58)
                       else
                       ui.set(refs.antiaim.body_yaw[2], 58)
   ...
   elseif  not ( ui.get(anti_aim[var.p_state].yaw_xway)  == "Delayed Tick" ) then
       ...
       if not (  ui.get(anti_aim[var.p_state].yaw_xway)  == "Delayed Tick" ) then
           if (ui.get(anti_aim[var.p_state_before_defensive].yaw_tickbase_def_method) == "Random yaw" or ui.get(anti_aim[var.p_state_before_defensive].yaw_tickbase_def_method) == "Random yaw + force") and var.p_state == 15 then
               local randomyaw = client.random_int(69,169)
               c.yaw = clamp360((globals.tickcount() % 6 < 3 and randomyaw or -randomyaw) + yaw_to_add)
           elseif  ui.get(anti_aim[var.p_state_before_defensive].yaw_tickbase_def_method) == "Second Pitch" then
...
renderer.indicator(200, 200, 200, 255,  "EDGE") 
end
...
ui.set_callback(Information_Bar,handle_menu)
...
local logo = string.upper("Burning Flame")
local build = string.upper("\aFFFFFFFF[beta]")
...
local function Debug_panelx()
   ...
   if ui.get(Debug_panel) == "v2" then
       ...
       items = {}
        ...
        local dt_on = (ui.get(items.keys.dt[1]) and ui.get(items.keys.dt[2]))
        local hs_on = (ui.get(items.keys.hs[1]) and ui.get(items.keys.hs[2]))
        if to_draw == "yes" and ui.get(refs.ragebot.double_tap[2]) and ui.get(refs.ragebot.double_tap[1]) then
            to_draw_ticks = to_draw_ticks + 1
            if to_draw_ticks == 27 then
                to_draw_ticks = 0
        ...
        local dtlag = ui.get(refs.ragebot.double_tap_fake_lag_limit)
       if contains(ui.get(Debug_panel_selector),"Logo") then 
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text( 300+4 , scrsize_y/2 + offset, r, g, b, a , "bc", 0, "              Burning Flame  ANTI-AIM - \aFFFFFFFFSYSTEM  PANEL")
       end 
       if contains(ui.get(Debug_panel_selector),"Build") then 
            offset = spacing * multiplier
            multiplier = multiplier + 2
            renderer.text( 300-73 , scrsize_y/2 + offset, 255, 255, 255, alpha, "bc", 0, "Beta")
        end
       if contains(ui.get(Debug_panel_selector),"Anti-aim state") then 
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text( 300-73 , scrsize_y/2 + offset, r, g, b, a , "bc", 0, "\aFFFFFFFFAA")
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text( 300-82 , scrsize_y/2 + offset, r, g, b, a , "ab", 0, "\aFFFFFFFF -   currect state :   \aFFFFFFFF" .. string.upper(aa_state))
           offset = spacing * multiplier
           multiplier = multiplier + 1
           if var.manual_dir == "left" then
                renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   manual :   left" )
            elseif var.manual_dir == "right" then
                renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   manual :   right" )
            elseif (ui.get(refs.antiaim.freestanding[1]) and ui.get(refs.antiaim.freestanding[2]))  and not ui.get (refs.ragebot.duck_peek_assist) and not ui.get (refs.antiaim.slow_motion[2]) then
                renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   manual :   freestanding" )
            elseif var.manual_dir == "back" then
                renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   manual :   at targets" )
            elseif var.manual_dir == "forward" then
                renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   manual :   forward" )
            end
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text( 300-82 , scrsize_y/2 + offset, r, g, b, a , "ab", 0, "\aFFFFFFFF -   body yaw angle :   \aFFFFFFFF" .. body_yaw2)
       end
       if contains(ui.get(Debug_panel_selector),"EXP") then 
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text(300-80 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFFEXP" )
           offset = spacing * multiplier
            multiplier = multiplier + 1
            renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   type :   ")
           if dt_on and not ui.get(refs.ragebot.duck_peek_assist) then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFFdt")
           elseif hs_on and not ui.get(refs.ragebot.duck_peek_assist) then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFFhs")
           else
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFFdisable")
           end
            offset = spacing * multiplier
            multiplier = multiplier + 1
            ...
            local color_dt = charged and  {r=255, g=255, b=255, a=255} or {r=225, g=51, b=51, a=255}
            local text_dt = charged and  "Ready" or "Charging"
            renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   charge :   ")
            if ui.get(refs.ragebot.double_tap[2])  and not ui.get(refs.ragebot.duck_peek_assist) then
                renderer.text(300-22 , scrsize_y/2 + offset, color_dt.r,color_dt.g,color_dt.b,color_dt.a, "ab", 0, "    " .. text_dt)
            elseif hs_on and not ui.get(refs.ragebot.duck_peek_assist) then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    safe")
            else
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    disable")
            end 
       end
       if contains(ui.get(Debug_panel_selector),"LC") then 
           
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text(300-80 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFFLC" )
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   active :   ")
           if hs_on and not ui.get(refs.ragebot.duck_peek_assist) and not dt_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF +")
           else
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -")
           end
           offset = spacing * multiplier
           ...
           renderer.text(300-82 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF -   ticks left :   ")
            if not hs_on and not dt_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    ".. fl)
            elseif hs_on and not dt_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    1")
            elseif contains(ui.get(disable_fl_onshot_disablers),"Double tap") and dt_on and not hs_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    1") -- DT开  不抬头不开   开修复
            elseif contains(ui.get(disable_fl_onshot_disablers),"Double tap") and dt_on and hs_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    1") -- DT和不抬头 都开 开修复
            elseif not contains(ui.get(disable_fl_onshot_disablers),"Double tap") and dt_on and hs_on then
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    1") -- 不开修复onshot 但是DT和不开头开
            elseif not contains(ui.get(disable_fl_onshot_disablers),"Double tap") and dt_on and not hs_on then 
                renderer.text(300-22 , scrsize_y/2 + offset, r, g, b, a, "ab", 0, "\aFFFFFFFF    1") --不开修复 开DT  不开不抬头 
           end
        end
   end 
end
...
if menu.gettype == "Centered" then
   ...
   if menu.getstyle == "Minimalistic" then
       ...
       renderer.text(cx + math.floor(add_x) , cy + 30 + offset, 200, 200, 200, 255, "-c", 0, body_yaw2.."")
       offset = spacing * multiplier
       multiplier = multiplier + 1
       ...
       if ui.get(refs.ragebot.duck_peek_assist)  then
           renderer.text(cx  + math.floor(add_x), cy + 20 + offset,  200, 200, 200, 255, '-c', 0, "FD")
           offset = spacing * multiplier
           multiplier = multiplier + 1
       end 
       ...
       if ui.get(refs.antiaim.hide_shots[1]) and ui.get(refs.antiaim.hide_shots[2]) and not ui.get(refs.ragebot.duck_peek_assist) then
           renderer.text(cx  + math.floor(add_x), cy + 30 + offset,  200, 200, 200, 255, '-c', 0, "OS")
           offset = spacing * multiplier
           multiplier = multiplier + 1
       end
       ...
       if (ui.get(refs.antiaim.freestanding[1]) and ui.get(refs.antiaim.freestanding[2]))  and not ui.get (refs.ragebot.duck_peek_assist) and not ui.get (refs.antiaim.slow_motion[2]) then
           renderer.text(cx  + math.floor(add_x), cy + 30 + offset,  200, 200, 200, 255, '-c', 0, "FS")
           offset = spacing * multiplier
           multiplier = multiplier + 1
       end
       ...
       elseif menu.getstyle  == "Modern" then
           ...
           local logotip = gradient_text(rr, gg, bb, 255, r1, g1, b1, 255, ("Burning Flame"))
           renderer.text(cx + math.floor(add_x) - 40, cy + 13 + offset, 200, 200, 200, 255, "ab", 0, string.upper(logotip))
           offset = spacing * multiplier
...
elseif menu.gettype == "Both" then
       ...
       local color_dt = {
           {   text = "DOUBLETAP",
               color = charged and  {200, 200, 200, 255} or {225, 51, 51, 255},
       ...
       if menu.getstyle == "Minimalistic" then
           ...
           if (ui.get(refs.antiaim.freestanding[1]) and ui.get(refs.antiaim.freestanding[2]))  and not ui.get (refs.ragebot.duck_peek_assist) and not ui.get (refs.antiaim.slow_motion[2]) then
               renderer.text(cx  + math.floor(add_x), cy + 20 + offset,  200, 200, 200, 255, '-c', 0, "FS")
               offset = spacing * multiplier
               multiplier = multiplier + 1
           end
           ...
           if ui.get(refs.antiaim.hide_shots[2]) and not ui.get(refs.ragebot.duck_peek_assist) then
               renderer.text(cx  + math.floor(add_x), cy + 40 + offset,  200, 200, 200, 255, '-c', 0, "OS")
               offset = spacing * multiplier
               multiplier = multiplier + 1
           end
           ...
           if ui.get(refs.ragebot.minimum_damage_override[1]) and ui.get(refs.ragebot.minimum_damage_override[2]) then
               renderer.text(cx  + math.floor(add_x), cy + 40 + offset , 255,255,155,210 ,'-c', 0, 'DMG: '.. ui.get(refs.ragebot.minimum_damage))
               offset = spacing * multiplier
               multiplier = multiplier + 1
           end
       ...
       elseif menu.getstyle  == "Modern" then
           ...
           local text_size = { renderer.measure_text("-", "Burning Flame") };
           ...
           offset = spacing * multiplier
           multiplier = multiplier + 1
           renderer.text(cx + math.floor(add_x), cy + 45, rr, gg, bb, aa, "-c", 0, "Burning Flame")
           renderer.text(cx + math.floor(add_x), cy + 25,  r1, g1, b1, alpha, "-c", 0, "Beta")
           ...
           if ui.get(refs.antiaim.hide_shots[2]) and not ui.get(refs.ragebot.duck_peek_assist) then
               offset = spacing * multiplier
               multiplier = multiplier + 1
               renderer.text(cx + math.floor(add_x), cy + 45 + offset, 200, 200, 200, 255, "-c", 0, "ONSHOT-AA")
           end
...
ui.set_visible(Information_Bar,false)
